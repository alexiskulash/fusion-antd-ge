  ...
  return (
    <div>
              ...
              <Col span={8}>
                ...
                >
                  <Form layout="vertical" size="small">
                    ...
                    <Form.Item
                      label={
                        <Text style={{ color: "white" }}>Patient ID:</Text>
                      }
                    >
                      <Row gutter={8}>
                        <Col span={4}>
            ...
            <div style={{ padding: "16px" }}>
              ...
              >
                ...
                >
                  ...
                  <Divider
                    style={{ margin: "8px 0", borderColor: "#4a5568" }}
                  />
      ...
      <style>{`
        ...
        .patient-record-table .ant-table-selection-col {
        ...
        .header-tabs .ant-tabs-tab-active {
          color: white !important;
        ...
        .header-tabs .ant-tabs-content-holder {
          display: none !important;
        }
